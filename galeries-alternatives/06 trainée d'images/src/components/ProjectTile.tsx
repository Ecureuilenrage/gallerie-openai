...
export type ProjectTileProps = {
  ...
  /** L'image remplit une cellule dont la taille est imposée par la vue (Bento/Justified). */
  fill?: boolean;
  /** Titre/auteur en overlay sur l'image plutôt qu'en légende dessous. */
  overlayTitle?: boolean;
  /** false = média seul, le texte est géré par la vue (Editorial). */
  showCaption?: boolean;
  /** false quand la vue gère elle-même l'élévation (HoverExpand/Spotlight/Coverflow). */
...
export default function ProjectTile(props: ProjectTileProps) {
  ...
  const ariaLabel = `${project.title} — ${project.author}, ouvrir (${
    project.kind === 'site' ? 'site' : 'page'
  })`;
